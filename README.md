...
[`docs/NOTES.md`](docs/NOTES.md) is the working journal kept while this was assembled:
what was tried, what broke, and why each piece ended up the way it is — the switch from
GlazeWM to komorebi, from Zebar to YASB, and the measurements behind the dock's animations.
